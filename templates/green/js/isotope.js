...
(function (t) {
    ...
    function o(t) {
        function o(t) {
            if ("string" == typeof t && (t = document.querySelector(t)), t && "object" == typeof t && t.nodeType) {
                ...
                var m = n.paddingLeft + n.paddingRight, g = n.paddingTop + n.paddingBottom, v = n.marginLeft + n.marginRight, _ = n.marginTop + n.marginBottom, I = n.borderLeftWidth + n.borderRightWidth, L = n.borderTopWidth + n.borderBottomWidth, z = h && p, S = e(o.width);
    ...
    function n(t, n, r) {
        ...
        var p = r("transition"), u = r("transform"), h = p && u, f = !!r("perspective"), c = {WebkitTransition: "webkitTransitionEnd", MozTransition: "transitionend", OTransition: "otransitionend", transition: "transitionend"}[p], l = ["transform", "transition", "transitionDuration", "transitionProperty"], d = function () {
        ...
        a.prototype._transitionTo = function (t, e) {
            ...
            var a = t - i, p = e - o, u = {}, h = this.layout.options;
            a = h.isOriginLeft ? a : -a, p = h.isOriginTop ? p : -p, u.transform = y(a, p), this.transition({to: u, onTransitionEnd: {transform: this.layoutPosition}, isCleaning: !0})
    ...
    function s(i, s, f, l, d, y) {
        ...
        var v = 0, _ = {};
        return m.namespace = "outlayer", m.Item = y, m.prototype.options = {containerStyle: {position: "relative"}, isInitLayout: !0, isOriginLeft: !0, isOriginTop: !0, isResizeBound: !0, transitionDuration: "0.4s", hiddenStyle: {opacity: 0, transform: "scale(0.001)"}, visibleStyle: {opacity: 1, transform: "scale(1)"}}, e(m.prototype, f.prototype), m.prototype.option = function (t) {
            e(this.options, t)
            ...
            for (var n = [], r = 0, s = t.length; s > r; r++) {
                var a = t[r], p = this._getItemLayoutPosition(a);
            ...
            return Object.create ? o.prototype = Object.create(m.prototype) : e(o.prototype, m.prototype), o.prototype.constructor = o, g(o, "options"), e(o.prototype.options, i), o.namespace = t, o.data = m.data, o.Item = function () {
                ...
                for (var e = r(t), i = a.querySelectorAll(".js-" + e), n = "data-" + e + "-options", s = 0, h = i.length; h > s; s++) {
                    var f, c = i[s], l = c.getAttribute(n);
                    try {
                        f = l && JSON.parse(l)
                    } catch (d) {
    ...
    function r(t, i, r, p, h) {
        function f(t, e) {
            return function (i, o) {
                for (var n = 0, r = t.length; r > n; n++) {
                    var s = t[n], a = i.sortData[s], p = o.sortData[s];
                    if (a > p || p > a) {
        ...
        var l = function () {
            function t(t) {
                ...
                var i = a(t).split(" "), o = i[0], n = o.match(/^\[(.+)\]$/), r = n && n[1], s = e(r, o), p = c.sortDataParsers[i[1]];
    ...
    function e(t, e) {
        ...
        return o.prototype._resetLayout = function () {
            ...
            for (var r = this._getColGroup(n), s = Math.min.apply(Math, r), a = i(r, s), p = {x: this.columnWidth * a, y: s}, u = s + t.size.outerHeight, h = this.cols + 1 - r.length, f = 0; h > f; f++)this.colYs[a + f] = u;
            return p
