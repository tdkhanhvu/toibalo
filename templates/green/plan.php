...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="./css/datepicker/datepicker_layout.css" />
    ...
    <link rel="stylesheet" type="text/css" href="./css/core_joomla.css" />
    ...
    <link rel="stylesheet" type="text/css" href="./css/dropdown/select2.css" />
    <link rel="stylesheet" type="text/css" href="./css/weather/weather.css" />
    <link rel="stylesheet" type="text/css" href="./css/tooltip/jQuery.iPicture.css" />
    <link rel="stylesheet" type="text/css" href="./css/Button/button.css" />
    <link rel="stylesheet" type="text/css" href="./css/accordion/jquery-ui.css" />
    <link rel="stylesheet" type="text/css" href="./css/food.css" />
    <meta name="viewport"
          content="width=device-width, user-scalable=no, initial-scale=1.0, minimum-scale=1.0, maximum-scale=1.0">
    <style type="text/css">
        body {
            background-image: url(http://www.beautiful-templates.com/demo/templates-joomla/st_green/templates/st_green/backgrounds/b2.jpg);
        }
    </style>
    <style type="text/css">
        .avatar-wrapper {
...
<div class="clearfix">
<a id="avatar-go-to-top" href="http://www.beautiful-templates.com/demo/templates-joomla/st_green/#top"
   style="display: block;">
    <span></span>
</a>
        ...
        <div id="avatar-pos-top-left">
            <div class="avatar-module ">
                <div class="module-content">
                    ...
                    <div class="custom">
                        <p><img style="height:50px" src="./images/logo.png" border="0" alt=""></p></div>
                </div>
            </div>
                ...
                <div class="module-content">
                    <div class="avatar-nav-responsive clearfix">
                        ...
                        <ul class="menu clearfix avatar-main-menu">
                            <li class="item-101"><a class="body" href="./green.htm">Home</a></li>
                            <li class="item-104 current active"><a class=".st-projects"
                                                                   href="http://www.beautiful-templates.com/demo/templates-joomla/st_green/index.php">Xuất Phát</a>
                            </li>
                            <li class="item-105"><a class=".st-home"
                                                    href="http://www.beautiful-templates.com/demo/templates-joomla/st_green/index.php">Tham Quan</a>
                            </li>
                            <li class="item-106"><a class=".st-team"
                                                    href="http://www.beautiful-templates.com/demo/templates-joomla/st_green/index.php">Lời Khuyên</a>
                            </li>
                            <li class="item-107"><a class=".st-food"
                                                    href="http://www.beautiful-templates.com/demo/templates-joomla/st_green/index.php">Ẩm Thực</a>
                            </li>
                            <li class="item-108"><a class="#avatar-body-bottom-block"
                                                    href="http://www.beautiful-templates.com/demo/templates-joomla/st_green/index.php">Chi Phí</a>
                        </ul>
                    </div>
                </div>
            </div>
...
<div id="transport">
    <div>
        <div style="height:96%; width:100%;background-color:rgb(240, 223, 225);border:5px groove #FAB6C3">
            <div style="width:20%;float:left;">
                ...
                <p><img src="./images/transport/airplane.png"</p>
            </div>
    ...
    <div>
        <div style="height:96%; width:100%;background-color:rgb(231, 203, 236);border:5px groove #E094EE">
            <div style="width:20%;float:left;">
                <p><img src="./images/transport/train.png"</p>
            </div>
            <div style="width:76%;float:left;">
                <div class="parent">
    ...
    <div>
        <div style="height:96%; width:100%;background-color:rgb(220, 212, 236);border:5px groove #AE8FBD">
            <div style="width:20%;float:left;">
                <p><img src="./images/transport/coach.png"</p>
            </div>
            <div style="width:76%;float:left;">
                <div class="parent">
    ...
    <div>
        <div style="height:96%; width:100%;background-color:rgb(207, 234, 247);border:5px groove #6882D3">
            <div style="width:20%;float:left;">
                <p><img src="./images/transport/ship.png"</p>
            </div>
            <div style="width:76%;float:left;">
                <div class="parent">
    ...
    <div>
        <div style="height:96%; width:100%;background-color:rgb(207, 234, 247);border:5px groove #6882D3">
            <div style="width:20%;float:left;">
                <p><img src="./images/transport/motorbike.png"</p>
            </div>
            <div style="width:76%;float:left;">
                <div class="parent">
...
<div>
    <div style="height:96%; width:100%;background-color:rgb(240, 223, 225);border:5px groove #FAB6C3">
        <div style="width:10%;float:left;">
            ...
            <p class="info"><img src="./images/crowded/red_star.png"</p>
            <p class="info"><img src="./images/money/high.png"</p>
        </div>
...
<div>
    <div style="height:96%; width:100%;background-color:rgb(220, 212, 236);border:5px groove #AE8FBD">
        <div style="width:10%;float:left;">
            ...
            <p class="icon-sun weathericon"></p>
            <p class="info"><img src="./images/crowded/yellow_star.png"</p>
            <p class="info"><img src="./images/money/medium.png"</p>
        </div>
        <div style="width:88%;float:left;">
            <div class="parent">
...
<div>
    <div style="height:96%; width:100%;background-color:rgb(150, 233, 210);border:5px groove #32C5B4">
        <div style="width:10%;float:left;">
            ...
            <p class="icon-sun weathericon"></p>
            <p class="info"><img src="./images/crowded/green_star.png"</p>
            <p class="info"><img src="./images/money/medium.png"</p>
        </div>
        <div style="width:88%;float:left;">
            <div class="parent">
...
<div>
    <div style="height:96%; width:100%;background-color:rgb(207, 234, 247);border:5px groove #98bf21">
        <div style="width:10%;float:left;">
            ...
            <p class="icon-sun weathericon"></p>
            <p class="info"><img src="./images/crowded/green_star.png"</p>
            <p class="info"><img src="./images/money/low.png"</p>
        </div>
        <div style="width:88%;float:left;">
            <div class="parent">
                ...
                <div class="custom">
                    <div class="st-onepage">
                        <div class="st-home onepage-disappear" position="item-105">
                            ...
                            <div id="attraction_info" style="position:absolute;width:330px;height:600px;float:left;right:0px;overflow: auto">
...
<span class="saves-hover-txt-saved" style="display: none;">Đã thêm</span>
                                ...
                                <p style="font-size:14px;line-height:18px;text-align:justify;margin:0px"><img src="./images/icon/description.png" height="25px" width="25px"/><i id="attraction_description"></i></p>
                                <hr />
                                <p style="font-size:14px;line-height:18px;text-align:justify;margin:0px"> <img src="./images/icon/time.png" height="25px" width="25px"/> <b id="attraction_hour"></b></p>
                                <p style="font-size:14px;line-height:18px;text-align:justify;margin:0px"> <img src="./images/icon/price.png" height="25px" width="25px"/> <b id="attraction_price"></b></p>
                                <hr />
                                <p style="font-size:14px;line-height:18px;text-align:justify;margin:0px"><img src="./images/icon/address.png" height="25px" width="25px"/> <b id="attraction_address"></b></p>
                                <p style="font-size:14px;line-height:18px;text-align:justify;margin:0px"><img src="./images/icon/phone.png" height="25px" width="25px"/> <b id="attraction_phone"></b></p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="st-team onepage-disappear" position="item-106">
                            ...
                            <div class="row-fluid">
                                <div class="span3">
                                    ...
                                    <div class="vote-div" track="1"><img src="images/icon/select.png" class="vote-icon select unclicked"/><img src="images/vote/up.png" class="vote-icon up unclicked"/></div>
                                ...
                                <div class="span3">
                                    ...
                                    <div class="vote-div" track="2"><img src="images/icon/select.png" class="vote-icon select unclicked"/><img src="images/vote/up.png" class="vote-icon up unclicked"/></div>
                                ...
                                <div class="span3">
                                    ...
                                    <div class="vote-div" track="3"><img src="images/icon/select.png" class="vote-icon select unclicked"/><img src="images/vote/up.png" class="vote-icon up unclicked"/></div>
                                ...
                                <div class="span3">
                                    ...
                                    <div class="vote-div" track="4"><img src="images/icon/select.png" class="vote-icon select unclicked"/><img src="images/vote/up.png" class="vote-icon up unclicked"/></div>
                ...
                <div class="custom">
                    <div class="st-onepage">
                        <div class="st-food onepage-disappear" position="item-107">
                            <h1 class="st-heading">Ẩm Thực</h1>

                            <p class="st-sub-heading">Món ngon không nên bỏ lỡ</p>
                            <div class="span3">
                                <div class='thumb'>
                                    ...
                                    <div class='divLeft' style='left:0px'>
                                        <div class='divLeftImage' style='background:url(./images/com_tam.jpg);background-repeat:no-repeat;background-size:200% 100%'></div>
                                        <div class='divLeftShadow'></div>
                                    </div>
                                    <div class='divRight' style='left:0px;background-image:url(./images/com_tam.jpg);background-repeat:no-repeat;background-size:200% 100%'></div>
                                    ...
                                    <div class="vote-div" track="3" style="top:250px;right:20px"><img src="images/icon/select.png" class="vote-icon select unclicked"/><img src="images/vote/up.png" class="vote-icon up unclicked"/></div>
                                </div>
                            </div>
                            <div class="span3">
                                <div class='thumb'>
                                    <div class='someContent'>
                                        <div class='content'>Hủ tiếu Nam Vang là món hủ tiếu có nguồn gốc từ Campuchia nhưng do người Hoa chế biến, nguyên liệu chính là hủ tiếu khô, nước dùng chính là thịt bằm nhỏ, lòng heo nấu cùng</div>

                                    </div>
                                    <div class='divLeft' style='left:0px'>
                                        <div class='divLeftImage' style='background:url(./images/hu_tieu_nam_vang.jpg);background-repeat:no-repeat;background-size:200% 100%'></div>
                                        <div class='divLeftShadow'></div>
                                    </div>
                                    <div class='divRight' style='left:0px;background-image:url(./images/hu_tieu_nam_vang.jpg);background-repeat:no-repeat;background-size:200% 100%'></div>
                                    <img class="thumbnail-shadow" alt="bottom" src="http://www.nitinh.com/static/another_thumb/thumbnail-shadow.png"/>
                            ...
                            <div class="span3">
                                <div class='thumb'>
                                    <div class='someContent'>
                                        <div class='content'>Bánh khọt là loại bánh Việt Nam làm từ bột gạo, có nhân tôm, được rán và ăn kèm với rau sống, ớt tươi, chấm nước sốt mắm tôm (không phải mắm tôm hay mắm tôm chua)</div>

                                    </div>
                                    <div class='divLeft' style='left:0px'>
                                        <div class='divLeftImage' style='background:url(./images/banh_khot.jpg);background-repeat:no-repeat;background-size:200% 100%'></div>
                                        <div class='divLeftShadow'></div>
                                    </div>
                                    <div class='divRight' style='left:0px;background-image:url(./images/banh_khot.jpg);background-repeat:no-repeat;background-size:200% 100%'></div>
                                    <img class="thumbnail-shadow" alt="bottom" src="http://www.nitinh.com/static/another_thumb/thumbnail-shadow.png"/>
                            ...
                            <div class="span3">
                                <div class='thumb'>
                                    <div class='someContent'>
                                        <div class='content'>Thịt quả có thể ăn được, và tỏa ra một mùi đặc trưng, nặng và nồng, ngay cả khi vỏ quả còn nguyên. Một số người thấy sầu riêng có một mùi thơm ngọt ngào dễ chịu</div>

                                    </div>
                                    <div class='divLeft' style='left:0px'>
                                        <div class='divLeftImage' style='background:url(./images/sau_rieng.jpg);background-repeat:no-repeat;background-size:200% 100%'></div>
                                        <div class='divLeftShadow'></div>
                                    </div>
                                    <div class='divRight' style='left:0px;background-image:url(./images/sau_rieng.jpg);background-repeat:no-repeat;background-size:200% 100%'></div>
                                    <img class="thumbnail-shadow" alt="bottom" src="http://www.nitinh.com/static/another_thumb/thumbnail-shadow.png"/>
...
<div id="100" class="avatar-module ">
    <div class="module-content">
        ...
        <div class="custom">
            <div class="st-title">
                <h1 class="st-heading">Chi phí</h1>
...
<div id="vehicle">
    ...
    <ul id="vehicle_option">
        <li cost="0" class="vehicle_active">
            <img src="./images/budget/nocost.png" />
        </li>
        <li cost="500">
            <img src="./images/transport/coach.png" alt="coach" />
        </li>
        <li cost="900">
            <img src="./images/transport/ship.png" />
        </li>
        <li cost="1100">
            <img src="./images/transport/train.png" />
        </li>
        <li cost="2000">
            <img src="./images/transport/airplane.png" />
        </li>
    </ul>
...
<div id="accommodation">
    ...
    <ul id="accommodation_option">
        ...
        <li cost="100">
            <img src="./images/budget/hostel.png" />
        </li>
        <li cost="500">
            <img src="./images/budget/hotel.png" />
        </li>
        <li cost="1500">
            <img src="./images/budget/hotel_premium.png" />
        </li>
    </ul>
...
<div id="food">
    ...
    <ul id="food_option">
        ...
        <li cost="100">
            <img src="./images/budget/food_court.png" />
        </li>
        <li cost="500">
            <img src="./images/budget/restaurant.png" />
        </li>
        <li cost="1500">
            <img src="./images/budget/restaurant_premium.png" />
        </li>
    </ul>
...
<div id="transport">
    ...
    <ul id="transport_option">
        ...
        <li cost="50">
            <img src="./images/budget/bus.png" />
        </li>
        <li cost="400">
            <img src="./images/budget/taxi.png" />
        </li>
    </ul>
...
<div id="personal_expense">
    ...
    <ul id="personal_expense_option">
        ...
        <li cost="100">
            <img src="./images/money/low.png" />
        </li>
        <li cost="300">
            <img src="./images/money/medium.png" />
        </li>
        <li cost="800">
            <img src="./images/money/high.png" />
        </li>
    </ul>
...
<div id="other">
    ...
    <ul id="other_option">
        <li cost="0">
            <img src="./images/budget/departure_tax.png" />
        </li>
        <li cost="0">
            <img src="./images/budget/visa.png" />
        </li>
    </ul>
...
<script src="./js/avatar-template.js"></script>
<script src="./js/date.js"></script>
<script src="./js/datepicker/datepicker.js"></script>
<script src="./js/dropdown/select2.min.js"></script>
<script src="http://cdnjs.cloudflare.com/ajax/libs/jquery-easing/1.3/jquery.easing.min.js"></script>
<script src="./js/zaccordion/jquery.zaccordion.min.js"></script>
<script src="./js/tooltip/ipicture-square.js"></script>
...
(function ($) {
    ...
    $("#slideshow").attr("src", "attraction.php");
})(jQuery)
</script>
<script type="text/javascript">
